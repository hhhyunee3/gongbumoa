  ...
  <div class="wrap">
    ...
    <div class="cat-grid">
      ...
      <a href="/others" class="cat cat-4 reveal">
        <span class="cat-ic">🎨</span>
        <h3>기타수업</h3>
        <p>논술·면접·시험 단기 집중 등 목표에 맞춘 다양한 특별 수업.</p>
...
<section><div class="wrap">
  <span class="sec-tag">선생님</span>
  <h2>과외 전문 선생님이 수업합니다</h2>
  <p class="sub" style="max-width:780px">공부모아의 선생님은 경력이 증명된 과외 전문 선생님입니다. 학년별 교과와 학교 시험 유형을 다뤄본 경험을 바탕으로, 지금 이 학생에게 무엇부터 손대야 하는지 판단해 커리큘럼을 짭니다.</p>
  <p class="sub" style="max-width:780px">그래서 상담에서 보는 것은 성적표 숫자보다 학생의 상태입니다. 어느 단원에서 이해가 끊겼는지, 질문을 어려워하는 성향인지, 혼자 공부하는 시간이 얼마나 되는지를 확인하고 선생님을 정합니다. 초반에 맞지 않는다고 느끼시면 다른 선생님과 다시 만나보실 수 있습니다.</p>
</div></section>
<!--QUICK_LINKS-->
...
const GUIDES = {
  math: {
    ...
    routine: ['수학은 주 2회 과외 수업만으로는 부족하고, 수업 사이의 자기 학습이 성적을 결정합니다. 권장 주간 루틴은 이렇습니다. 수업 당일에는 배운 내용을 30분 안에 백지에 다시 정리해보고, 다음 날 숙제로 유형 문제를 풀며, 주말에는 한 주간 틀린 문제만 모아 다시 풉니다. 여기에 매일 15분의 연산 또는 기초 문제 루틴을 더하면 감이 끊기지 않습니다. 중요한 것은 총 공부 시간이 아니라 "매일 수학을 만나는 것"입니다. 주말에 몰아서 4시간 하는 것보다 매일 40분이 수학에서는 확실히 효과적입니다.', '수학 실력은 수업 시간이 아니라 수업과 수업 사이에 자랍니다. 배운 날 저녁 30분 안에 그날 내용을 백지에 재현해보고, 이틀 안에 숙제로 유형을 굳히고, 주말에는 그 주에 틀린 문제만 다시 푸는 3단 리듬을 권합니다. 여기에 매일 15분 연산 루틴을 깔아두면 계산 실수가 줄고 감이 유지됩니다. 핵심은 총량이 아니라 빈도입니다. 주말 4시간 몰아치기보다 매일 40분이 수학에서는 항상 이깁니다.', '수학 루틴의 원칙은 하나입니다. 하루도 수학과 헤어지지 않기. 수업 날은 30분 복습(백지 재현), 다음 날은 숙제, 주말은 오답 재풀이로 역할을 나누고, 그 사이를 매일 15분 연산이 이어줍니다. 시간표에 "수학 2시간"이라고 크게 잡는 것보다 "매일 40분"이 지켜지기도 쉽고 효과도 큽니다. 공부량이 아니라 공백 없음이 수학 감각을 지킵니다.', '수학 루틴에서 흔한 착각은 ‘주말에 몰아서’입니다. 수학 감각은 냉장고 없던 시절의 생선과 같아서 이틀만 방치해도 상합니다. 또 하나의 착각은 ‘숙제만 하면 된다’입니다. 숙제는 최소한이고, 배운 날의 백지 복습과 주말 오답 재풀이가 실력을 만드는 부분입니다. 매일 40분의 원칙을 시간표보다 습관에 새기세요.', '수학 공부는 근육 운동과 같습니다. 헬스장에 주 1회 3시간 가는 사람보다 매일 30분 하는 사람이 몸이 바뀌듯, 수학도 매일 만나는 사람이 이깁니다. 수업(PT)에서 자세를 배웠으면 혼자 하는 반복(자율 운동)으로 근육에 새겨야 하고, 오답 재풀이는 안 되던 동작을 다시 교정받는 시간입니다. 연산 15분은 매일의 스트레칭입니다.',
      '학년에 따라 루틴의 무게중심이 다릅니다. 초등은 매일 연산 10분으로 계산 감각을 지키는 것이 우선이고, 중등은 수업 당일 복습과 오답 정리에 무게를 둡니다. 고등은 여기에 주 1회 모의고사형 시간 재기 연습을 더해야 실전 감각이 유지됩니다. {p} 학생의 학년과 현재 상태에 맞춰 어느 쪽에 시간을 더 쓸지 정해드립니다.',
      '루틴을 만들 때 가장 먼저 할 일은 시간을 새로 만드는 것이 아니라 이미 쓰고 있는 시간을 찾아내는 것입니다. 학원 이동 시간, 저녁 식사 직후 30분, 자기 전 20분처럼 이미 비어 있는 자리에 수학을 끼워 넣으면 새로 결심할 일이 줄어듭니다. 하루를 통째로 비우려는 계획일수록 오래가지 못합니다.',
      '루틴이 잘 돌아가는지는 세 가지로 확인합니다. 첫째, 어제 배운 내용을 백지에 재현할 수 있는가. 둘째, 오답 노트에 같은 유형이 반복해서 들어오지 않는가. 셋째, 숙제를 하는 데 걸리는 시간이 조금씩 줄고 있는가. 이 중 하나라도 어긋나면 공부량이 아니라 방법을 점검할 때입니다.',
      '집에서 도울 수 있는 일은 생각보다 단순합니다. 문제를 같이 풀어주는 것이 아니라, 오늘 배운 것 하나만 설명해 달라고 청하는 것입니다. 설명이 막히는 지점이 곧 다시 봐야 할 지점이고, 아이는 설명하면서 스스로 정리합니다. 채점과 지적은 수업에 맡기고 가정에서는 듣는 역할만 맡아주세요.',
      '루틴은 반드시 무너집니다. 시험 기간, 여행, 아픈 날이 지나면 어김없이 끊깁니다. 중요한 것은 무너지지 않는 계획이 아니라 다시 세우는 방법입니다. 끊긴 뒤에는 밀린 진도를 따라잡으려 하지 말고, 가장 최근에 배운 단원 하나만 복습하며 돌아오세요. 밀린 것을 다 메우려다 영영 못 돌아오는 경우가 훨씬 많습니다.'
    ],
    exam: ['시험 4주 전부터는 계획이 달라져야 합니다. 4주 전에는 시험 범위의 개념을 처음부터 훑으며 구멍을 확인하고, 3주 전에는 유형서로 범위 내 전 유형을 한 바퀴 돕니다. 2주 전부터는 학교 기출과 유사 문제로 실전 감각을 만들고 서술형 답안 쓰기를 연습합니다. 마지막 1주는 새 문제를 벌리지 말고 그동안 틀린 문제만 다시 푸는 기간입니다. 시험 전날 밤에 새 유형을 만나 불안해지는 것이 최악의 시나리오이므로, 마지막 3일은 오답 복습과 컨디션 관리에 집중하세요.', '시험 4주 전이 되면 공부의 성격을 바꿔야 합니다. 첫 주는 범위 전체 개념을 훑으며 구멍 지도를 그리는 주, 둘째 주는 유형서 한 바퀴, 셋째 주는 학교 기출과 유사 문제로 실전 감각과 서술형 답안을 다듬는 주입니다. 마지막 주에는 새 문제를 벌리지 말고 그동안의 오답만 반복하세요. 시험 전날 처음 보는 유형에 흔들리는 것이 최악이므로, 마지막 3일은 아는 것을 확실하게 만드는 데 씁니다.', '시험 대비는 역할이 다른 4개의 주로 설계합니다. 첫 주는 정찰(범위 개념 훑기와 구멍 찾기), 둘째 주는 훈련(유형서 1회독), 셋째 주는 실전(학교 기출·서술형 답안), 마지막 주는 정비(오답만 반복)입니다. 많은 학생이 마지막 주에 새 문제집을 펴는 실수를 하는데, 시험 직전의 낯선 문제는 실력이 아니라 불안만 늘립니다. 마지막 3일은 아는 것을 굳히는 시간입니다.', '시험 대비에서 가장 흔한 실수 세 가지: 마지막 주에 새 문제집 펴기, 서술형 연습을 눈으로만 하기, 쉬운 단원부터 공부하기입니다. 새 문제는 불안을, 눈 연습은 감점을, 쉬운 단원 우선은 시간 부족을 낳습니다. 순서를 뒤집으세요. 약한 단원부터, 손으로 쓰면서, 마지막 주는 오답만. 이 세 가지 교정만으로 같은 실력에서 시험 점수가 달라집니다.', '시험 4주는 농사의 계절과 같습니다. 1주차는 밭을 살피는 때(범위 훑기·구멍 확인), 2주차는 씨 뿌리는 때(유형 훈련), 3주차는 김매는 때(기출·서술형 다듬기), 마지막 주는 수확 준비(오답 정리와 컨디션)입니다. 수확 직전에 새 씨앗을 뿌리는 농부는 없습니다. 마지막 주에 새 문제를 벌리지 않는 이유입니다.',
      '여러 과목 시험이 몰리는 주간에는 순서가 점수를 가릅니다. 수학은 손이 굳으면 바로 티가 나는 과목이라 시험 전날 몰아서 푸는 방식이 가장 위험합니다. 시험 시간표를 받으면 수학이 있는 날에서 거꾸로 계산해, 마지막 3일 안에 반드시 문제 푸는 시간을 배치하세요. 암기 과목은 그 뒤로 미루는 편이 안전합니다.',
      '남은 기간이 4주가 아니라면 계획도 달라야 합니다. 2주가 남았다면 범위 전체를 훑을 시간이 없으므로, 배점이 크고 출제가 확실한 단원부터 순서를 정해 집중합니다. 1주가 남았다면 새 개념을 보태는 대신 학교 기출과 이미 틀린 문제만 반복하는 것이 점수에 가장 가깝습니다.',
      '지금 성적대에 따라 같은 4주를 다르게 씁니다. 기초가 흔들리는 학생은 범위 전체보다 앞부분 개념 복구에 절반을 쓰는 편이 결과가 좋고, 중위권은 틀리는 유형만 골라 반복하는 데 시간을 몰아야 합니다. 상위권은 개념이 아니라 실수 관리와 킬러 문항 한두 개의 완성도에서 등급이 갈립니다.',
      '시험이 끝난 다음 일주일이 다음 시험의 출발선입니다. 채점 결과보다 중요한 것은 틀린 이유를 개념·계산·문제 해석 셋으로 나눠 기록하는 일입니다. 개념이면 그 단원으로 돌아가고, 계산이면 연습량 문제이며, 해석이면 문제 읽는 훈련이 필요합니다. 이 분류가 다음 4주 계획의 뼈대가 됩니다.',
      '아는 문제를 틀리는 것은 실력이 아니라 습관의 문제입니다. 시험지를 받으면 전체를 훑어 배점과 난이도를 확인하고, 막히는 문제는 표시만 하고 넘어가는 연습을 평소 문제 풀이에서 해두어야 시험장에서 나옵니다. 검산은 시간이 남으면 하는 것이 아니라 처음부터 계획에 넣어두는 것입니다.'
    ],
  ...
  english: {
    ...
    routine: ['영어는 하루에 몰아 하는 과목이 아니라 매일 쪼개서 하는 과목입니다. 권장 루틴은 매일 어휘 20분(새 단어 + 복습 단어), 격일 구문 독해 30분, 주 2회 듣기 15분입니다. 어휘는 외운 날 기준으로 다음 날과 일주일 뒤 두 번 복습하는 주기를 지키는 것이 양보다 중요합니다. 독해는 하루 한 지문이라도 구조를 분석하며 정독하는 것이 열 지문 훑는 것보다 낫습니다. 수업이 있는 날에는 수업에서 배운 구문 포인트가 들어간 문장을 스스로 두세 개 찾아보면 배움이 자기 것이 됩니다.', '영어는 몰아서 하면 새고, 쪼개서 하면 쌓이는 과목입니다. 매일 어휘 20분(새 단어와 복습 단어 반반), 이틀에 한 번 구문 독해 30분, 주 2회 듣기 15분이 기본 틀입니다. 어휘는 외운 다음 날과 일주일 뒤 두 번의 복습 주기를 지키는 것이 양보다 중요하고, 독해는 열 지문을 훑기보다 한 지문을 구조 분석하며 정독하는 쪽이 실력이 됩니다. 수업에서 배운 구문이 들어간 문장을 스스로 두세 개 찾아보면 그날 배움이 완전히 자기 것이 됩니다.', '영어 루틴은 세 개의 작은 약속으로 만듭니다. 매일 어휘 20분, 이틀에 한 번 정독 30분, 주 2회 듣기 15분. 여기서 정독은 열 지문 훑기가 아니라 한 지문을 구조 분석하며 읽는 것을 뜻합니다. 어휘 복습은 다음 날과 일주일 뒤, 두 번의 주기를 지키는 것이 전부입니다. 작은 약속이라 지켜지고, 지켜지기 때문에 쌓입니다.', '영어 루틴의 흔한 실패는 ‘주말에 단어 200개’입니다. 기억은 만남의 횟수에 비례하지 한 번의 길이에 비례하지 않습니다. 또 하나, 듣기를 시험 전에만 하는 것도 실패 공식입니다. 귀는 벼락치기가 안 되는 기관입니다. 매일 어휘 20분, 격일 정독 30분, 주 2회 듣기 15분. 시시해 보이는 이 루틴이 몰아치기를 항상 이깁니다.', '영어는 화초 기르기와 같습니다. 주말에 물을 왕창 주는 것보다 매일 조금씩 주는 것이 뿌리를 만듭니다. 어휘 복습 주기는 물 주기 간격이고, 정독은 분갈이(뿌리를 깊게), 듣기는 햇빛(자연 노출)입니다. 하루 이틀 거른다고 시들지 않지만, 한 달을 거르면 다시 살리는 데 세 달이 걸립니다.',
      '학년마다 시간을 어디에 쓸지가 다릅니다. 초등은 소리와 문장에 익숙해지는 시간이 우선이고, 중등은 어휘와 교과서 본문 구조 분석에 무게를 둡니다. 고등은 여기에 시간을 재고 지문을 읽는 훈련이 더해져야 수능형 속도가 만들어집니다. {p} 학생의 학년에 맞춰 비중을 조정해 드립니다.',
      '영어 루틴은 새 시간을 만들기보다 자투리를 모으는 쪽이 오래갑니다. 등하교 시간의 듣기, 식사 직후 10분의 어휘 확인처럼 이미 있는 틈에 붙이면 결심이 덜 필요합니다. 하루 한 시간을 통째로 비우는 계획은 대개 첫 주를 넘기지 못합니다.',
      '루틴이 작동하는지는 이렇게 확인합니다. 지난주에 외운 단어를 오늘 물어봤을 때 절반 이상 남아 있는가, 처음 보는 문장을 끊어 읽을 수 있는가, 듣기를 할 때 아는 단어가 들리기 시작했는가. 셋 중 막히는 곳이 다음 주에 시간을 더 써야 할 지점입니다.',
      '가정에서는 단어 시험 감독보다 짧은 확인이 효과적입니다. "오늘 배운 문장 하나만 읽어봐" 정도면 충분합니다. 발음을 고쳐주려 하기보다 끝까지 듣고 반응해 주는 편이, 아이가 영어로 입을 여는 횟수를 늘립니다.',
      '어휘 암기는 반드시 새는 구간이 옵니다. 외운 만큼 잊는 시기가 오면 대개 "이 방법이 안 맞나" 생각하지만, 사실은 복습 주기가 무너진 것뿐입니다. 이럴 때는 새 단어를 멈추고 지난 2주치만 다시 도는 것이 회복이 빠릅니다.'
    ],
    exam: ['내신 4주 플랜은 이렇게 짭니다. 4주 전에는 교과서와 부교재 본문의 해석을 완성하고 모르는 어휘를 정리합니다. 3주 전에는 본문 속 문법 포인트(시제, 관계사, 분사 등)를 문장 단위로 분석하고, 2주 전부터는 학교별 기출과 변형 문제로 출제 스타일에 적응합니다. 서술형 배점이 큰 학교라면 이 시기에 영작 연습을 반드시 포함해야 합니다. 마지막 주는 본문 흐름과 빈출 문장을 최종 점검하고, 틀렸던 변형 문제를 다시 풀며 마무리합니다.', '내신 영어의 4주 설계는 이렇습니다. 4주 전 교과서·부교재 본문 해석 완성과 어휘 정리, 3주 전 본문 속 문법 포인트 문장 단위 분석, 2주 전부터 학교 기출과 변형 문제 적응 훈련. 서술형 배점이 큰 학교라면 이 시기에 영작 연습이 반드시 들어가야 합니다. 마지막 주는 본문 흐름과 빈출 문장 최종 점검, 그리고 틀렸던 변형 문제 재풀이로 마무리합니다.', '내신 영어 4주는 이렇게 흘러갑니다. 1주차 본문 해석 완성과 어휘 정리, 2주차 본문 속 문법 포인트 분석, 3주차 기출·변형 문제 적응(서술형 학교라면 영작 포함), 4주차 빈출 문장과 오답 최종 점검. 변형 문제는 학교마다 스타일이 달라, 우리 학교 유형을 아는 것이 문제집 한 권보다 가치 있습니다.', '내신 영어 대비의 흔한 실수는 본문 한글 해석 암기입니다. 변형 문제 앞에서 무너지는 지름길입니다. 문장 구조를 분석해두면 어떤 변형에도 대응이 되지만, 해석만 외우면 어순 바뀐 문장 하나에 흔들립니다. 서술형 학교에서 영작 연습 없이 시험장에 가는 것도 예고된 감점입니다. 4주 플랜에 구조 분석과 손 영작을 반드시 넣으세요.', '내신 영어 4주는 요리 준비와 같습니다. 1주차는 장보기(본문 해석·어휘 정리), 2주차는 재료 손질(문법 포인트 분석), 3주차는 시연(기출·변형 문제로 리허설), 마지막 주는 플레이팅 점검(빈출 문장·오답 확인)입니다. 손질 없이 시연부터 하면 재료(본문)가 낯설고, 시연 없이 본 시험은 첫 요리를 손님상에 올리는 격입니다.',
      '시험이 몰리는 주간에는 영어를 어디에 둘지가 중요합니다. 영어는 본문이 손에 익어야 하는 과목이라 하루 이틀 몰아치면 변형 문제에서 무너집니다. 시험 3주 전부터 매일 조금씩이라도 본문을 만지고, 암기 과목을 시험 직전으로 미루는 배치가 안전합니다.',
      '남은 기간이 짧다면 우선순위를 좁혀야 합니다. 2주가 남았다면 본문 해석 완성과 학교 기출에 집중하고 새 문제집은 펴지 않습니다. 1주가 남았다면 서술형 배점이 큰 학교인지부터 확인하고, 영작·주요 문장 암기에 시간을 몰아주는 편이 점수에 직결됩니다.',
      '성적대에 따라 4주의 쓰임이 다릅니다. 기초 단계는 본문 해석과 기본 어휘에 대부분을 써야 하고, 중위권은 문법 포인트와 변형 문제 적응에서 점수가 오릅니다. 상위권은 서술형 감점 요인과 고난도 유형의 정답률 관리가 등급을 가릅니다.',
      '시험이 끝나면 답지보다 시험지를 봅니다. 틀린 문항을 어휘·구문·문법·서술형으로 나눠 표시해 두면, 우리 학교가 어디에서 점수를 가져가는지 한 학기 안에 뚜렷해집니다. 그 표가 다음 시험 4주 계획의 근거가 됩니다.',
      '영어 시험에서 아는 것을 놓치는 자리는 대체로 정해져 있습니다. 지시문을 끝까지 읽지 않아 조건을 빠뜨리는 것, 서술형에서 철자와 어형으로 감점되는 것입니다. 평소 문제를 풀 때 조건에 밑줄을 긋는 습관을 들여야 시험장에서 나옵니다.'
    ],
  ...
  korean: {
    ...
    routine: ['국어 실력은 벼락치기가 통하지 않는 대신, 짧은 루틴의 누적에 가장 정직하게 반응합니다. 권장 루틴은 매일 비문학 한 지문 정독(15~20분), 주 3회 문학 작품 하나 분석, 주 1회 어휘·문법 정리입니다. 지문을 풀 때는 채점보다 분석에 시간을 쓰세요. 정답과 오답의 근거를 지문에서 찾아 표시하는 10분이 문제 열 개를 더 푸는 것보다 실력이 됩니다. 수업이 있는 날에는 수업에서 배운 독해 방법을 다른 지문 하나에 직접 적용해보는 것이 가장 좋은 복습입니다.', '국어는 벼락치기가 안 통하는 대신 짧은 루틴의 누적에 가장 정직하게 반응합니다. 매일 비문학 한 지문 15~20분 정독, 주 3회 문학 작품 분석, 주 1회 어휘·문법 정리가 기본입니다. 지문을 풀 때는 채점에 1분, 분석에 10분을 쓰세요. 정답과 오답의 근거를 지문에 표시하는 그 10분이 열 문제를 더 푸는 것보다 실력을 만듭니다. 수업이 있는 날에는 배운 독해법을 다른 지문 하나에 직접 적용해보는 것이 최고의 복습입니다.', '국어 루틴은 소박하지만 배신하지 않습니다. 매일 비문학 한 지문 정독, 주 3회 문학 작품 하나, 주 1회 어휘·문법 정리. 문제를 푼 뒤에는 채점 1분, 분석 10분의 비율을 지키세요. 정답과 오답의 근거를 지문에서 찾아 표시하는 그 10분이 실력이 자라는 시간입니다. 빠르게 늘지 않지만, 한번 오르면 잘 떨어지지 않는 것이 국어입니다.', '국어 루틴의 흔한 실패는 시험 기간에만 국어를 보는 것입니다. 독해력은 시험 2주 전에 만들어지지 않습니다. 또 하나는 채점 후 바로 다음 지문으로 넘어가는 것입니다. 분석 없는 채점은 공부가 아니라 기록입니다. 매일 지문 하나 정독, 채점 1분에 분석 10분, 주 1회 어휘·문법. 이 소박한 루틴을 시험과 무관하게 돌리는 학생이 결국 이깁니다.', '국어 실력은 장 담그기와 같습니다. 하루아침에 안 되고, 매일의 온도(정독 습관)가 맛을 결정하며, 한번 제대로 익으면 오래갑니다. 문제 풀이는 간 보기일 뿐이고, 발효는 분석의 시간(근거 찾기 10분)에 일어납니다. 시험 전에만 급히 담근 장은 깊은 맛이 나지 않습니다.',
      '학년별로 무게중심이 다릅니다. 초등은 소리 내어 읽기와 어휘 확장이 우선이고, 중등은 문학 개념어와 지문 구조 파악에 시간을 씁니다. 고등은 시간을 재고 지문을 읽는 훈련과 선지 근거 찾기가 더해져야 합니다. {p} 학생의 학년과 현재 독해 상태에 맞춰 비중을 정합니다.',
      '국어 루틴은 시간을 새로 빼기보다 이미 읽고 있는 것을 활용하는 편이 오래갑니다. 등교 전 짧은 칼럼 하나, 자기 전 시 한 편처럼 기존 생활에 얹으면 부담이 적습니다. 하루 두 시간 독서 계획은 대개 첫 주에 끝납니다.',
      '루틴이 잘 굴러가는지는 이렇게 봅니다. 지문을 읽고 나서 한 문장으로 요약할 수 있는가, 틀린 문제의 근거를 지문에서 찾아낼 수 있는가, 모르는 어휘를 그냥 넘기지 않는가. 이 셋이 되면 성적은 시간을 두고 따라옵니다.',
      '가정에서는 독후감을 시키기보다 물어봐 주는 편이 낫습니다. "그래서 이 사람은 왜 그렇게 했대?" 같은 질문 하나가 줄거리 요약보다 훨씬 깊은 독해를 끌어냅니다. 정답을 확인하려는 질문이 아니라 궁금해서 묻는 질문이어야 아이가 답합니다.',
      '독해력은 늘고 있는데 점수가 그대로인 구간이 반드시 옵니다. 대개 읽기는 되는데 선지를 고르는 훈련이 부족한 시기입니다. 이때는 지문을 더 읽기보다, 이미 푼 문제의 오답 선지가 왜 틀렸는지 지문에서 근거를 찾는 연습으로 바꿔야 뚫립니다.'
    ],
    exam: ['내신 국어는 범위가 명확한 만큼 전략이 통합니다. 4주 전에는 시험 범위의 작품과 지문을 교과서 기준으로 정독하고 학교 필기를 정리합니다. 3주 전에는 작품별 핵심(주제, 표현상 특징, 시어·소재의 의미)을 노트로 만들고, 2주 전부터는 학교 기출과 문제집으로 출제 포인트를 확인합니다. 문법 단원이 범위에 있다면 이 시기에 개념-예문-문제의 순환을 두 바퀴 돌아야 합니다. 마지막 주는 필기 노트와 오답만 반복하며, 서술형 예상 문제의 모범 답안을 직접 써보는 것으로 마무리합니다.', '내신 국어는 범위가 정해져 있어 전략이 확실히 통합니다. 4주 전 시험 범위 작품·지문 정독과 학교 필기 정리, 3주 전 작품별 핵심 노트(주제, 표현상 특징, 시어의 의미) 제작, 2주 전 학교 기출과 문제집으로 출제 포인트 확인. 문법이 범위에 있다면 개념-예문-문제 순환을 이 시기에 두 바퀴 돌아야 합니다. 마지막 주는 필기와 오답만 반복하고, 서술형 예상 문제의 모범 답안을 직접 손으로 써보며 마무리하세요.', '내신 국어는 범위가 정해진 시험이라 준비한 만큼 나옵니다. 1주차 범위 작품·지문 정독과 필기 정리, 2주차 작품별 핵심 노트, 3주차 기출과 문제집으로 출제 포인트 확인, 4주차 오답과 필기 반복. 문법 단원이 있다면 2~3주차에 개념-예문-문제 순환을 두 바퀴 돌고, 서술형은 모범 답안을 눈으로 보지 말고 손으로 직접 써보는 것까지가 대비입니다.', '내신 국어 대비의 흔한 구멍은 학교 필기 무시와 서술형 눈 연습입니다. 출제자는 문제집 저자가 아니라 수업하신 선생님입니다. 필기와 강조점이 1순위 교재여야 합니다. 서술형을 눈으로만 준비하면 시험장에서 첫 문장이 안 나옵니다. 모범 답안을 직접 손으로 써보는 것까지가 대비입니다. 문법 범위는 개념-예문-문제 두 바퀴가 안전선입니다.', '내신 국어 4주는 공연 준비와 같습니다. 1주차 대본 리딩(작품·지문 정독과 필기 정리), 2주차 장면 분석(작품별 핵심 노트), 3주차 리허설(기출·예상 문제), 마지막 주 최종 점검(오답과 필기 반복). 무대에 오르기 전 대본을 손에서 놓지 않듯, 시험 전날의 주인공은 새 문제집이 아니라 학교 필기입니다.',
      '시험이 몰릴 때 국어는 뒤로 미루기 쉬운 과목입니다. 범위가 정해져 있어 늦게 시작해도 될 것 같지만, 작품 정리와 필기 확인에는 생각보다 시간이 걸립니다. 국어 시험일에서 거꾸로 계산해 최소 2주 전에는 작품별 정리를 시작하는 배치가 안전합니다.',
      '남은 기간이 짧다면 범위 안에서도 순서를 정해야 합니다. 2주가 남았다면 학교 필기가 많은 작품부터 정리하고, 1주가 남았다면 새 문제집 대신 기출과 필기, 그리고 서술형 답안 쓰기에 시간을 몰아주는 편이 점수에 가깝습니다.',
      '성적대별로 4주의 쓰임이 갈립니다. 기초 단계는 작품 내용과 어휘를 확실히 잡는 데 대부분을 쓰고, 중위권은 표현상 특징과 서술형 답안 형식에서 점수가 오릅니다. 상위권은 지엽적 필기와 낯선 변형 지문 대응에서 등급이 갈립니다.',
      '시험이 끝나면 틀린 문항을 어휘·내용 이해·근거 찾기·서술형으로 나눠 봅니다. 우리 학교가 지엽적 암기를 묻는지, 사고력을 묻는지가 두 번째 시험이면 보입니다. 그 파악이 다음 시험 준비의 방향을 정합니다.',
      '국어에서 아는 것을 놓치는 자리는 대개 선지의 조건입니다. "적절하지 않은 것"을 "적절한 것"으로 읽는 실수는 긴장해서가 아니라 평소 습관에서 옵니다. 문제를 풀 때 발문의 부정어에 표시하는 연습을 해두면 시험장에서 줄어듭니다.'
    ],
  ...
  science: {
    ...
    routine: ['과학은 개념을 배운 직후의 복습이 가장 중요합니다. 권장 루틴은 수업 당일 배운 단원의 개념을 그림·흐름도로 한 장에 정리하고, 이틀 안에 관련 문제를 풀어 이해를 확인하는 것입니다. 주말에는 한 주 동안 배운 내용의 그래프와 표만 모아 다시 읽어보세요. 자료 해석 감각은 이렇게 짧게 자주 만나야 자랍니다. 계산형 단원(물리·화학)은 공식 유도 과정을 일주일에 한 번 백지에 재현해보는 것이 공식 암기보다 오래갑니다.', '과학은 배운 직후의 복습이 승부처입니다. 수업 당일 그 단원을 그림과 흐름도로 한 장에 정리하고, 이틀 안에 문제로 이해를 검증하세요. 주말에는 한 주간 나온 그래프와 표만 모아 다시 읽는 시간을 15분만 가져도 자료 해석 감각이 자랍니다. 물리·화학의 공식은 유도 과정을 일주일에 한 번 백지에 재현해보는 것이 단순 암기보다 훨씬 오래갑니다.', '과학 복습의 골든타임은 배운 당일입니다. 그날 저녁 단원 내용을 그림과 흐름도로 한 장 정리하고, 이틀 안에 문제로 검증하세요. 주말 15분은 그 주의 그래프·표만 다시 보는 시간으로 씁니다. 공식은 외우지 말고 일주일에 한 번 유도 과정을 백지에 재현해보세요. 유도할 수 있는 공식은 잊어버려도 다시 만들 수 있습니다.', '과학 복습의 흔한 실패는 시험 전 몰아 정리입니다. 한 달치 그래프와 용어를 이틀에 소화하려니 체하는 것입니다. 배운 날의 한 장 정리, 이틀 내 문제 검증, 주말 15분 자료 훑기로 나누면 같은 내용이 부담 없이 쌓입니다. 공식을 결과만 외우는 것도 위험합니다. 유도를 백지에 재현하는 주 1회 훈련이 응용 문제의 보험입니다.', '과학 지식은 시멘트와 같아서 배운 직후가 굳기 전의 골든타임입니다. 당일 정리는 틀을 잡는 일이고, 이틀 내 문제 풀이는 양생 과정이며, 주말 자료 복습은 표면 점검입니다. 굳은 뒤에 고치려면 깨고 다시 발라야 하지만, 젖어 있을 때는 손끝으로도 모양이 잡힙니다.',
      '학년에 따라 무게중심이 다릅니다. 초등은 현상을 관찰하고 왜 그런지 말해보는 시간이 우선이고, 중등은 개념과 그래프 해석에 시간을 씁니다. 고등은 여기에 계산 훈련과 단원 간 연결 정리가 더해져야 합니다. {p} 학생의 학년과 막히는 지점에 맞춰 비중을 정합니다.',
      '과학 루틴은 새 시간을 빼기보다 수업 직후 10분을 지키는 쪽이 훨씬 효율적입니다. 배운 날 저녁에 흐름도 한 장을 그리는 데 드는 시간은 짧지만, 이걸 건너뛰면 시험 기간에 몇 시간을 다시 써야 합니다. 하루 두 시간 계획보다 그날 10분이 결과를 바꿉니다.',
      '루틴이 작동하는지는 이렇게 확인합니다. 배운 개념을 그림으로 그려 설명할 수 있는가, 그래프를 보고 무엇을 나타내는지 바로 말할 수 있는가, 실험 문항에서 과정과 변인을 구분하는가. 막히는 항목이 다음 주에 시간을 더 쓸 지점입니다.',
      '가정에서는 문제를 봐주기보다 현상을 함께 궁금해하는 편이 낫습니다. 뉴스나 날씨, 요리 중에 나오는 과학 이야기를 한 번씩 짚어주면 교과서 개념이 실제와 연결됩니다. 암기로만 남은 지식은 시험이 끝나면 사라지지만, 연결된 지식은 다음 학년까지 갑니다.',
      '과학은 개념은 아는데 문제가 안 풀리는 구간이 반드시 옵니다. 대개 개념과 계산 사이의 다리가 없는 시기입니다. 이때는 개념서를 다시 읽기보다, 이미 푼 문제에서 어떤 개념이 어떤 식으로 쓰였는지 거꾸로 짚는 연습으로 바꿔야 뚫립니다.'
    ],
    exam: ['과학 내신 4주 플랜입니다. 4주 전에는 교과서와 학교 프린트로 시험 범위 개념을 정리하고, 3주 전에는 단원별 문제 풀이로 이해를 점검합니다. 2주 전부터는 학교 기출 스타일의 자료 해석·계산 문제를 집중 연습하고, 실험 단원이 범위에 있다면 과정·변인·유의점을 서술형 틀로 정리합니다. 마지막 주는 오답과 학교 필기 중심으로 반복하되, 선생님이 수업 중 강조한 부분을 최우선으로 점검하세요. 과학 내신은 수업 자료에서 그대로 출제되는 비율이 높은 과목입니다.', '과학 내신 4주 플랜입니다. 4주 전 교과서와 학교 프린트로 범위 개념 정리, 3주 전 단원별 문제 풀이로 점검, 2주 전부터 자료 해석·계산 문항 집중 훈련. 실험이 범위에 있으면 과정·변인·유의점을 서술형 틀로 정리해 두세요. 과학 내신은 수업 자료에서 그대로 나오는 비율이 높은 과목이라, 마지막 주는 선생님이 강조한 부분과 학교 필기를 최우선으로 반복하는 것이 정답입니다.', '과학 시험 4주 설계입니다. 1주차 교과서·프린트 개념 정리, 2주차 단원별 문제 점검, 3주차 자료 해석·계산 집중 훈련과 실험 단원 서술형 틀 정리, 4주차 학교 필기와 오답 반복. 과학 내신은 다른 과목보다 수업 자료 출제 비율이 높아, 마지막 주에 문제집보다 선생님 강조 부분을 다시 보는 것이 점수에 직결됩니다.', '과학 시험 대비의 흔한 구멍은 학교 프린트 경시입니다. 시중 문제집을 세 권 풀어도 선생님 프린트의 그 그래프에서 출제됩니다. 실험 단원을 결과만 정리하는 것도 감점 예약입니다. 조작·통제 변인과 유의점까지 서술형 틀로 준비하세요. 마지막 주에 새 문제를 벌리는 대신 필기와 오답을 반복하는 것, 과학에서는 특히 이 원칙이 점수로 직결됩니다.', '과학 내신 4주는 실험 절차와 같습니다. 1주차 준비물 확인(교과서·프린트 개념 정리), 2주차 예비 실험(단원별 문제), 3주차 본 실험(자료 해석·계산 집중, 실험 서술형 틀), 4주차 결과 정리(필기·오답 반복). 본 실험 없이 시험장에 가는 것은 첫 실험을 평가받는 셈이고, 준비물(수업 자료) 없는 실험은 시작부터 성립하지 않습니다.',
      '시험이 몰리는 주간에 과학은 계산 감각이 필요한 과목이라 마지막에 몰아 하기 어렵습니다. 시험 시간표를 받으면 과학이 있는 날에서 거꾸로 계산해, 마지막 3일 안에 계산·자료 해석 문항을 푸는 시간을 반드시 넣으세요. 순수 암기 단원은 그 뒤로 미뤄도 됩니다.',
      '남은 기간이 짧다면 범위를 좁혀야 합니다. 2주가 남았다면 학교 프린트와 교과서 탐구 활동에 집중하고, 1주가 남았다면 새 문제집 대신 프린트의 그래프와 실험 과정, 그리고 이미 틀린 문제만 반복하는 편이 점수에 가장 가깝습니다.',
      '성적대에 따라 4주를 다르게 씁니다. 기초 단계는 용어와 개념 정리에 절반을 쓰고, 중위권은 자료 해석과 계산 유형 반복에서 점수가 오릅니다. 상위권은 실험 설계 문항과 서술형 답안의 정확도에서 등급이 갈립니다.',
      '시험이 끝나면 틀린 문항을 개념·계산·자료 해석·실험 서술로 나눠 봅니다. 우리 학교가 계산형인지 암기형인지, 실험 문항 비중이 큰지가 두 번째 시험이면 드러납니다. 그 파악이 다음 4주의 배분을 정합니다.',
      '과학에서 아는 것을 놓치는 자리는 대체로 단위와 조건입니다. 답은 맞는데 단위를 빠뜨리거나, 문제에 주어진 조건을 놓치는 감점입니다. 평소 문제를 풀 때 단위를 반드시 적고 조건에 표시하는 습관을 들여야 시험장에서 나옵니다.'
    ],
  ...
  social: {
    ...
    routine: ['사회는 한 번에 오래 보는 것보다 짧게 여러 번 보는 것이 압도적으로 유리한 과목입니다. 권장 루틴은 수업 당일 배운 단원을 목차 구조로 정리(15분)하고, 이틀 뒤 백지에 흐름을 재현해보는 것입니다. 재현이 막히는 부분이 바로 다시 봐야 할 부분입니다. 주말에는 한 주간 배운 내용의 자료(지도, 도표, 사진)만 모아 훑어보세요. 역사라면 연표에 이번 주 배운 사건을 직접 추가하는 습관이 시대 감각을 만들어줍니다.', '사회는 오래 한 번 보는 것보다 짧게 여러 번 보는 것이 압도적으로 유리합니다. 수업 당일 배운 단원을 목차 구조로 15분 정리하고, 이틀 뒤 백지에 그 흐름을 재현해보세요. 막히는 지점이 곧 복습 지점입니다. 주말에는 그 주에 나온 지도·도표·사진 자료만 모아 훑고, 역사라면 나만의 연표에 이번 주 사건을 직접 추가하는 습관이 시대 감각을 만들어줍니다.', '사회는 만나는 횟수가 기억량을 결정합니다. 수업 당일 목차 구조로 15분 정리, 이틀 뒤 백지 재현, 주말에 자료만 훑기. 이 세 번의 짧은 만남이 시험 전 벼락치기보다 확실합니다. 역사라면 나만의 연표에 이번 주 사건을 추가하는 5분 습관이 시대 감각을 만들고, 백지 재현에서 막힌 부분이 곧 다음 복습의 목차가 됩니다.', '사회 루틴의 흔한 실패는 시험 2주 전 몰아치기 단권화입니다. 구조 없이 급조한 정리는 시험장에서 인출되지 않습니다. 평소의 15분 목차 정리, 이틀 뒤 백지 재현, 주말 자료 훑기가 시험 기간의 부담을 미리 분산해줍니다. 백지 재현을 건너뛰는 것이 특히 아쉬운 지점입니다. 막히는 곳이 곧 복습 지점이라는 정보를 버리는 셈이기 때문입니다.', '사회 공부는 서랍 정리와 같습니다. 물건(지식)을 상자(목차 구조)에 넣어두면 필요할 때 바로 꺼내지만, 쌓아만 두면 있는 줄도 모릅니다. 수업 당일의 15분은 상자에 라벨을 붙이는 시간이고, 백지 재현은 눈 감고 서랍을 열어보는 점검이며, 주말 자료 훑기는 사진첩(지도·도표)을 정리하는 일입니다.',
      '학년에 따라 루틴이 다릅니다. 초등은 교과서 사진과 지도를 함께 보며 이야기로 익히는 시간이 우선이고, 중등은 목차 구조 정리에 무게를 둡니다. 고등은 여기에 자료 해석과 선택과목별 개념 비교가 더해져야 합니다. {p} 학생의 학년에 맞춰 비중을 조정합니다.',
      '사회 루틴은 새 시간을 만들기보다 짧게 자주 만나는 쪽이 유리합니다. 등하교 시간에 목차만 훑기, 저녁 식사 후 15분 정리처럼 짧은 만남을 여러 번 배치하면 암기량이 확실히 줄어듭니다. 주말에 몰아서 세 시간 보는 계획은 대개 남지 않습니다.',
      '루틴이 작동하는지는 이렇게 확인합니다. 단원 이름만 보고 큰 흐름을 말할 수 있는가, 헷갈리는 개념 두 개를 비교해 설명할 수 있는가, 자료(지도·도표)를 보고 무엇을 뜻하는지 아는가. 막히는 곳이 다음 주의 우선순위입니다.',
      '가정에서는 외웠는지 확인하기보다 오늘 배운 것 중 하나를 이야기해 달라고 청하는 편이 낫습니다. 사회는 설명하면서 구조가 잡히는 과목이라, 듣는 사람이 있는 것만으로 정리가 됩니다. 뉴스에 나온 이슈를 아이 눈높이로 한 번씩 얹어주면 교과 개념이 살아납니다.',
      '사회는 외웠는데 시험에서 안 나오는 구간이 옵니다. 대개 낱개로 외우고 구조로 묶지 않은 시기입니다. 이때는 더 외우기보다, 이미 정리한 노트를 목차만 보고 백지에 재현하는 연습으로 바꿔야 시험장에서 인출됩니다.'
    ],
    exam: ['사회 내신 4주 플랜입니다. 4주 전에는 교과서를 목차 중심으로 통독하며 전체 구조를 잡고, 3주 전에는 단원별 세부 개념을 정리 노트로 만듭니다. 2주 전부터는 문제 풀이로 헷갈리는 개념을 골라내 비교 표로 정리하고, 학교 기출이 있다면 출제 스타일(자료형·서술형 비중)을 확인합니다. 마지막 주는 새로운 정리를 만들지 말고 기존 노트와 오답을 반복하세요. 시험 전날에는 선생님이 강조한 부분과 자료 페이지만 빠르게 훑는 것이 효율적입니다.', '사회 내신은 4주 설계로 잡습니다. 4주 전 교과서 목차 중심 통독으로 뼈대 세우기, 3주 전 단원별 정리 노트 제작, 2주 전 문제 풀이로 헷갈리는 개념을 골라 비교표 만들기. 학교 기출이 있다면 자료형·서술형 비중을 확인해 대비 방향을 맞추세요. 마지막 주는 새 정리를 만들지 말고 기존 노트와 오답만 반복하며, 시험 전날은 선생님 강조 부분과 자료 페이지만 빠르게 점검합니다.', '사회 내신 4주는 뼈대에서 세부로 내려가는 설계입니다. 1주차 목차 중심 통독으로 전체 구조 잡기, 2주차 단원별 정리 노트, 3주차 문제 풀이와 헷갈리는 개념 비교표, 4주차 노트·오답 반복. 학교 기출로 자료형과 서술형 비중을 미리 확인해 대비 방향을 맞추고, 시험 전날은 선생님 강조 부분과 자료 페이지만 빠르게 점검하세요.', '사회 시험의 흔한 감점 요인은 서술형 핵심어 누락과 자료 페이지 경시입니다. 내용을 알아도 채점 기준의 그 단어가 빠지면 점수가 깎이고, 교과서 구석의 사진·지도가 그대로 출제됩니다. 통독으로 뼈대를 잡고, 비교표로 헷갈림을 정리하고, 마지막 주에 선생님 강조점과 자료만 다시 보는 순서를 지키면 사회는 배신하지 않는 과목이 맞습니다.', '사회 내신 4주는 지도 제작 과정입니다. 1주차 항공 촬영(목차 통독으로 전체 지형 파악), 2주차 세부 측량(단원별 노트), 3주차 국경 확정(헷갈리는 개념 비교표), 4주차 최종 검수(오답·강조점 점검). 세부부터 그리기 시작한 지도는 반드시 어딘가 어긋납니다. 전체에서 세부로, 이 순서가 사회 공부의 지도 제작법입니다.',
      '시험이 몰릴 때 사회는 마지막으로 미루기 쉬운 과목입니다. 암기 과목이라 벼락치기가 될 것 같지만, 구조 없이 급조한 암기는 서술형에서 무너집니다. 시험 3주 전에는 목차 정리를 끝내두고, 마지막 주를 반복에 쓰는 배치가 안전합니다.',
      '남은 기간이 짧다면 순서를 정해야 합니다. 2주가 남았다면 목차 통독과 학교 필기 정리에 집중하고, 1주가 남았다면 새 정리를 만들지 말고 기존 노트와 자료 페이지, 서술형 핵심어 확인에 시간을 몰아주세요.',
      '성적대별로 4주가 달라집니다. 기초 단계는 목차 구조와 기본 용어에 대부분을 쓰고, 중위권은 헷갈리는 개념 비교표에서 점수가 오릅니다. 상위권은 자료 해석 문항과 서술형 핵심어 누락 관리에서 등급이 갈립니다.',
      '시험이 끝나면 틀린 문항을 개념·자료 해석·서술형 핵심어로 나눠 봅니다. 우리 학교가 자료형인지 암기형인지, 서술형 배점이 어느 정도인지가 두 번째 시험이면 뚜렷해집니다. 그것이 다음 4주 계획의 근거가 됩니다.',
      '사회에서 점수를 놓치는 자리는 대체로 서술형의 채점 키워드입니다. 내용을 알아도 채점 기준의 그 단어가 빠지면 깎입니다. 평소 정리할 때 교과 용어를 그대로 쓰는 습관을 들이면 시험장에서 일상어로 풀어쓰는 실수가 줄어듭니다.'
    ],
  ...
  essay: {
    ...
    routine: ['글쓰기 실력은 쓰는 빈도에 비례합니다. 권장 루틴은 주 2회 짧은 글쓰기(독서 감상, 시사 논평 등 500자 내외)와 주 1회 요약 연습(칼럼이나 기사 한 편을 세 문장으로)입니다. 쓴 글은 하루 묵혔다가 스스로 소리 내어 읽어보세요. 어색한 문장은 눈보다 귀가 먼저 찾아냅니다. 첨삭을 받았다면 지적받은 부분을 반영해 같은 글을 한 번 더 고쳐 쓰는 것까지가 한 세트입니다. 고쳐 쓰기 없는 첨삭은 절반의 효과밖에 내지 못합니다.', '글은 쓰는 빈도만큼 늡니다. 주 2회 500자 내외의 짧은 글(독서 감상, 시사 한 줄 논평)과 주 1회 요약 연습(칼럼 한 편을 세 문장으로)이 기본 루틴입니다. 쓴 글은 하루 묵혔다가 소리 내어 읽어보세요. 어색한 문장은 눈보다 귀가 먼저 찾습니다. 첨삭을 받았다면 지적을 반영해 같은 글을 한 번 더 고쳐 쓰는 것까지가 한 세트입니다. 고쳐 쓰기 없는 첨삭은 절반짜리입니다.', '글 근육은 빈도로 자랍니다. 주 2회 500자 글쓰기와 주 1회 요약 연습이 기본 세트입니다. 완성한 글은 하루 재웠다가 소리 내어 읽으며 스스로 고쳐보세요. 귀는 눈이 놓친 어색함을 잡아냅니다. 첨삭을 받았다면 반영해서 같은 글을 다시 쓰는 것까지가 진짜 한 회차입니다. 쓰기-첨삭-고쳐쓰기의 삼박자가 도는 순간부터 글은 계단식으로 늡니다.', '글쓰기 루틴의 흔한 실패는 영감을 기다리는 것입니다. 쓸 기분은 쓰기 시작한 뒤에 옵니다. 또 하나는 완성 직후의 퇴고입니다. 방금 쓴 글은 자기 눈에 완벽해 보입니다. 주 2회 짧은 글, 주 1회 요약, 하루 재운 뒤 소리 내어 읽는 퇴고, 첨삭 후 고쳐쓰기. 이 사이클에 영감이 낄 자리는 없고, 실력이 늘 자리만 있습니다.', '글쓰기는 반죽 숙성과 같습니다. 쓰는 것은 반죽이고, 하루 재우는 것은 숙성이며, 소리 내어 읽는 퇴고는 반죽 상태를 손으로 확인하는 일입니다. 숙성 없이 바로 구운 빵이 부푸는 법이 없듯, 쓰자마자 제출한 글은 제 맛이 나지 않습니다. 첨삭은 레시피 교정이고, 고쳐쓰기는 같은 빵을 다시 구워보는 것까지를 말합니다.',
      '학년에 따라 훈련이 다릅니다. 초등은 자기 생각을 문장으로 만드는 연습이 우선이고, 중등은 주장과 근거의 구조를 익히는 시기입니다. 고등은 제시문을 분석해 논지를 세우는 훈련으로 넘어가야 합니다. {p} 학생의 학년과 현재 글에 맞춰 단계를 정합니다.',
      '글쓰기 루틴은 긴 시간을 확보하기보다 짧게 자주 쓰는 쪽이 오래갑니다. 하루 세 문장이라도 매일 쓰는 사람이, 주말에 두 시간을 비우려는 사람보다 결국 더 많이 씁니다. 분량보다 빈도를 먼저 지키세요.',
      '루틴이 작동하는지는 이렇게 확인합니다. 글을 시작하기까지 걸리는 시간이 줄고 있는가, 개요 없이 쓰다가 길을 잃는 일이 줄었는가, 자기 글에서 고칠 곳을 스스로 찾는가. 이 셋이 되면 글은 확실히 늘고 있는 중입니다.',
      '가정에서는 글을 고쳐주기보다 읽고 반응해 주는 편이 낫습니다. "이 부분은 왜 그렇게 생각했어?" 같은 질문 하나가 문장 교정보다 논리를 키웁니다. 맞춤법 지적부터 시작하면 아이는 다음 글을 쓰기 싫어집니다.',
      '글이 늘지 않는 것처럼 느껴지는 구간이 반드시 옵니다. 대개 쓰는 양은 늘었는데 읽는 양이 따라가지 못한 시기입니다. 이때는 더 쓰기보다, 잘 쓴 글 한 편을 구조로 분해해 보는 연습이 막힌 곳을 뚫습니다.'
    ],
    exam: ['대입 논술을 준비한다면 시기별 계획이 필요합니다. 고1~2는 요약과 개요 작성 훈련으로 기본기를 쌓는 시기이고, 고3 여름부터는 목표 대학 기출로 실전 훈련에 들어가야 합니다. 시험 4주 전에는 주 2회 실전 시간(대학별 90~120분)에 맞춰 완성글을 쓰고 첨삭받는 사이클을 돌립니다. 2주 전부터는 새 주제보다 이미 쓴 글을 다시 고쳐 쓰며 자신의 약점 패턴(논리 비약, 분량 배분)을 교정합니다. 수행평가 글쓰기라면 채점 기준표를 먼저 분석하고 기준별로 답안에 반영하는 연습이 가장 효율적입니다.', '대입 논술은 시기별 설계가 필요합니다. 고1~2는 요약과 개요 작성으로 기본기를 쌓는 시기, 고3 여름부터는 목표 대학 기출로 실전에 들어가야 합니다. 시험 4주 전에는 대학별 시험 시간(90~120분)에 맞춘 완성글 쓰기와 첨삭 사이클을 주 2회 돌리고, 2주 전부터는 새 주제보다 이미 쓴 글을 고쳐 쓰며 자기 약점 패턴(논리 비약, 분량 배분)을 교정합니다. 수행평가라면 채점 기준표 분석과 기준별 반영 연습이 가장 효율적입니다.', '논술 준비는 시기가 전략입니다. 고1~2는 요약·개요라는 기본기의 시간, 고3 여름부터는 목표 대학 기출의 실전 시간입니다. 시험 4주 전에는 대학별 제한 시간에 맞춘 완성글-첨삭 사이클을 주 2회 돌리고, 마지막 2주는 새 주제 대신 쓴 글을 고쳐 쓰며 자기 약점 패턴을 교정하세요. 수행평가라면 채점 기준표를 분석해 항목별로 반영하며 쓰는 것이 최단 경로입니다.', '논술 준비의 흔한 실수는 고3 가을에 시작하는 것과 새 주제만 계속 쓰는 것입니다. 늦은 시작은 첨삭-교정 사이클을 돌 시간을 없애고, 새 주제 사냥은 자기 약점 패턴을 교정할 기회를 없앱니다. 고1~2 기본기, 고3 여름 실전 진입, 시험 4주 전 주 2회 실전 사이클, 마지막 2주는 쓴 글 고쳐쓰기. 수행평가라면 기준표 분석이 곧 답안 설계도입니다.', '논술 시험 준비는 마라톤 훈련 일정과 같습니다. 고1~2는 기초 체력기(요약·개요), 고3 여름은 코스 적응기(대학별 기출), 시험 4주 전은 페이스 조절기(제한 시간 완주 연습)입니다. 대회 직전에 새 코스를 뛰는 선수는 없습니다. 마지막 2주는 달려본 코스(쓴 글)의 기록을 줄이는 시간입니다.',
      '내신 수행평가와 대입 논술은 준비가 다릅니다. 수행평가는 채점 기준표가 공개된 시험이라 기준 항목을 역산해 쓰면 점수가 오르고, 논술은 대학별 출제 유형에 맞춘 훈련이 필요합니다. 지금 무엇을 준비하는지에 따라 시간 배분이 달라집니다.',
      '남은 기간이 짧다면 새 주제를 늘리지 않는 것이 원칙입니다. 2주가 남았다면 이미 쓴 글 두세 편을 제대로 고쳐 완성도를 올리고, 1주가 남았다면 제한 시간 안에 개요를 잡는 연습에 집중하는 편이 실전에 가깝습니다.',
      '현재 글 수준에 따라 훈련이 갈립니다. 시작 단계는 개요 짜기와 문단 나누기에 대부분을 쓰고, 중간 단계는 근거의 구체성에서 점수가 오릅니다. 상위 단계는 반론 고려와 제시문 활용의 정교함에서 평가가 갈립니다.',
      '글을 쓴 뒤에는 첨삭을 받는 것으로 끝내지 말고, 지적받은 항목을 유형별로 모아두세요. 문장이 긴지, 근거가 약한지, 구조가 흔들리는지가 서너 편이면 패턴으로 보입니다. 그 패턴이 다음에 무엇을 훈련할지 알려줍니다.',
      '시험장에서 글이 무너지는 자리는 대개 시간 배분입니다. 개요에 쓸 시간을 아끼려다 중간에 길을 잃고 다시 쓰는 경우가 가장 흔합니다. 전체 시간의 4분의 1을 개요에 쓰는 연습을 평소에 해두면 실전에서 완성하지 못하는 일이 줄어듭니다.'
    ],
...
function regionSubjectPage({ sido, sgg, dong, subj, url }) {
  ...
  const titleTail = (() => {
    if (dong && dongSchools.length) {
      ...
      // 초등학교만 있는 동은 내신이 없으므로 "학교 맞춤수업"으로 쓴다.
      const tail = dongSchools.some(x => x[1] !== '초') ? '내신 맞춤수업' : '학교 맞춤수업';
      if (names.length >= 2 && two.length <= 14) return `${two} ${tail}`;
      if (names[0].length <= 10) return `${names[0]} ${tail}`;
    }
    if (!dong) {
...
${dongSchools.length ? `<p class="sub">${esc(place)}에는 ${dongSchools.length > 5 ? `${dongSchools.slice(0, 5).map(x => esc(x[0])).join(', ')} 등 ${dongSchools.length}곳이` : J(dongSchools.slice(0, 5).map(x => esc(x[0])).join(', '), '이', '가')} 있습니다. ${esc(place)} 학생이 다니는 학교의 ${subj.name} 시험 범위와 출제 스타일을 기준으로 수업을 준비합니다.</p>` : `<p class="sub">${esc(place)} 학생들이 주로 다니는 ${esc(sgg.disp)} 학교의 ${subj.name} 시험 스타일에 맞춰 수업합니다.</p>`}
<p class="sub">학교를 선택하면 맞춤 안내를 볼 수 있어요.</p>
<div class="linkcol">
...
<span class="sec-tag">인근 학교</span>
<h2>${esc(sgg.disp)} ${grade.name === '초등' ? '초등학교' : grade.name === '중등' ? '중학교' : '고등학교'} ${subj.name} ${grade.name === '초등' ? '과외' : '내신'}</h2>
<div class="linkcol">
${gSchools.map(s => `<a href="/schools/${s[4]}/${subj.slug}">${esc(s[0])} ${subj.name} ${grade.name === '초등' ? '과외' : '내신'}</a>`).join('')}
</div>
</div></section>` : ''}
...
<section><div class="wrap">
<span class="sec-tag">수업 방식</span><h2>방문 수업과 화상 수업, 모두 가능합니다</h2>
<p class="sub" style="max-width:780px">선생님이 집으로 찾아가는 방문 수업은 이동 시간이 들지 않고, 아이가 익숙한 자리에서 공부하니 집중이 흐트러지지 않습니다. 거리가 멀거나 일정이 빠듯하다면 화상 수업으로도 같은 커리큘럼을 이어갈 수 있습니다. 두 방식을 섞어 평일은 화상, 주말은 방문으로 진행하는 학생도 많습니다.</p>
<p class="sub" style="max-width:780px">지역을 나눠 안내하는 이유는 같은 학년, 같은 과목이라도 학교마다 시험이 다르기 때문입니다. 서술형 비중, 교과서 밖 자료 출제 여부, 수행평가 반영 비율이 학교별로 달라서, 그 지역 학교 사정을 아는 선생님과 만나는 편이 대비가 정확합니다.</p>
</div></section>

<section><div class="wrap">
<span class="sec-tag">선생님</span><h2>과외 전문 선생님이 수업합니다</h2>
<p class="sub" style="max-width:780px">공부모아의 선생님은 경력이 증명된 과외 전문 선생님입니다. 학년별 교과와 학교 시험 유형을 다뤄본 경험을 바탕으로, 지금 이 학생에게 무엇부터 손대야 하는지를 판단해 커리큘럼을 짭니다.</p>
<p class="sub" style="max-width:780px">그래서 상담에서 확인하는 것은 성적표 숫자보다 학생의 상태입니다. 어느 단원에서 이해가 끊겼는지, 질문을 못 하는 성향인지, 집에서 혼자 공부하는 시간이 얼마나 되는지를 보고 선생님을 정합니다. 초반에 맞지 않는다고 느끼시면 다른 선생님과 다시 만나보실 수 있습니다.</p>
</div></section>

<section><div class="wrap">
<span class="sec-tag">지역과 학교</span><h2>동네가 다르면 준비도 달라집니다</h2>
<p class="sub" style="max-width:780px">같은 시군구 안에서도 동네마다 학생들이 다니는 학교가 다릅니다. 어떤 동네는 중학교가 두세 곳뿐이라 시험 경향이 뚜렷하고, 어떤 동네는 여러 학교로 흩어져 대비 방향이 갈립니다. 지역 페이지를 동 단위까지 나눈 것은 그 동네 학생이 실제로 다니는 학교를 기준으로 안내하기 위해서입니다.</p>
<p class="sub" style="max-width:780px">지역을 고르시면 그 동네에 있는 학교와 인근 학교, 과목별 수업 안내를 함께 보실 수 있습니다. 학년까지 선택하면 그 학년에서 무엇을 먼저 잡아야 하는지도 정리해 두었습니다.</p>
</div></section>

<section><div class="wrap">
<span class="sec-tag">진행</span><h2>상담부터 첫 수업까지</h2>
<p class="sub" style="max-width:780px">먼저 학생의 학년과 과목, 지금 무엇이 막혀 있는지를 상담에서 확인합니다. 그 내용을 바탕으로 지역과 일정이 맞는 선생님을 안내해 드리고, 30분 정도의 무료 모의수업으로 아이에게 맞는 수업인지 먼저 확인하실 수 있습니다. 받아보신 뒤에 시작 여부를 정하시면 됩니다.</p>
<p class="sub" style="max-width:780px">수업이 시작되면 학교 진도와 시험 범위를 기준으로 커리큘럼을 짜고, 매주 학습 리포트로 무엇을 배웠고 어디가 부족한지 공유해 드립니다. 시험 기간에는 횟수를 늘려 대비하기도 합니다.</p>
<p class="sub" style="max-width:780px">시험 기간에만 짧게 받는 단기 수업은 운영하지 않습니다. 실력은 이어서 쌓일 때 성적으로 연결되기 때문입니다. 대신 정규 수업 안에서 시험 일정에 맞춰 횟수와 내용을 조절합니다. 상담과 모의수업까지는 비용이 들지 않으니, 받아보고 판단하셔도 됩니다.</p>
</div></section>
...
${faqBlock([
  { q: '여러 과목을 동시에 수강할 수 있나요?', a: '가능합니다. 과목마다 그 과목 전문 선생님을 각각 안내해 드리고, 수업 일정은 서로 겹치지 않게 조율해 드려요.' },
  { q: '과목마다 선생님이 다른가요?', a: '네, 과목마다 그 과목을 전문으로 하는 선생님이 담당합니다. 과목마다 필요한 지도 방식이 다르기 때문입니다.' },
  { q: '어떤 과목이 개설되어 있나요?', a: '초등부터 고등까지 전 과목 수업이 가능합니다. 수학·영어·국어·과학·사회·논술은 물론, 고등 선택과목(미적분, 확률과통계, 기하, 물리학, 화학, 생명과학, 지구과학, 생활과윤리, 사회문화, 한국지리, 정치와법 등)도 해당 과목 전문 선생님이 수업합니다.' },
])}

<section><div class="wrap">
<span class="sec-tag">선생님</span><h2>과목마다 그 과목 전문 선생님이 맡습니다</h2>
<p class="sub" style="max-width:780px">공부모아의 선생님은 경력이 증명된 과외 전문 선생님입니다. 그 과목의 교과 흐름과 학교 시험 유형을 다뤄본 선생님이 해당 과목을 담당합니다. 수학은 어느 단원에서 이해가 끊겼는지 찾는 눈이, 국어는 학생이 지문을 어떻게 읽는지 관찰하는 눈이 필요해서, 과목마다 요구되는 것이 다르기 때문입니다.</p>
<p class="sub" style="max-width:780px">초등부터 고등까지 전 과목을 다룹니다. 수학·영어·국어·과학·사회·논술은 물론 고등 선택과목(미적분, 확률과통계, 기하, 물리학, 화학, 생명과학, 지구과학, 생활과윤리, 사회문화, 한국지리, 정치와법 등)도 해당 과목 전문 선생님이 수업합니다.</p>
<p class="sub" style="max-width:780px">두 과목 이상이 필요하면 과목마다 선생님을 각각 안내해 드립니다. 수업 일정은 서로 겹치지 않게 조율해 드리고, 어느 과목부터 시작할지는 학생의 상태와 남은 시간을 보고 상담에서 정합니다.</p>
<p class="sub" style="max-width:780px">같은 수학이라도 다니는 학교의 시험 유형에 따라 준비가 달라집니다. 필요한 과목과 함께 지역과 학교를 문의로 남겨주시면, 그에 맞는 선생님과 커리큘럼을 안내해 드립니다.</p>
</div></section>

<section><div class="wrap">
<span class="sec-tag">학년</span><h2>학년에 따라 같은 과목도 다르게 접근합니다</h2>
<p class="sub" style="max-width:780px">초등은 진도를 빼는 것보다 학교 수업을 소화할 기초 체력을 만드는 시기입니다. 연산과 문해력이 흔들리면 이후 모든 과목이 함께 흔들리기 때문입니다. 중등은 처음 만나는 지필고사와 서술형에 적응하는 시기라, 시험 범위를 계획으로 옮기는 훈련이 필요합니다.</p>
<p class="sub" style="max-width:780px">고등은 내신 한 번이 등급으로 남아 대입까지 이어지므로, 모든 과목을 고르게 하기보다 등급이 움직일 수 있는 과목에 힘을 싣는 편이 유리합니다. 같은 과목이라도 학년에 따라 무엇에 시간을 쓸지가 이렇게 달라집니다.</p>
</div></section>

<section><div class="wrap">
<span class="sec-tag">과목 선택</span><h2>어떤 과목부터 시작할지 고민된다면</h2>
<p class="sub" style="max-width:780px">여러 과목이 동시에 불안할 때는 전부 시작하기보다 한두 과목에 힘을 싣는 편이 결과가 좋습니다. 기준은 단순합니다. 지금 가장 등급이 흔들리는 과목, 그리고 다음 학년까지 영향을 주는 과목입니다. 수학과 영어는 한 번 구멍이 생기면 다음 학년까지 이어지기 때문에 우선순위가 높은 편입니다.</p>
<p class="sub" style="max-width:780px">반대로 사회나 과학은 단원별로 끊어 대비가 가능해서, 시험 일정에 맞춰 집중 투입하는 방식이 통합니다. 국어와 논술은 짧게 몰아쳐서 오르는 과목이 아니라 꾸준한 루틴이 필요합니다. 무엇부터 손댈지는 상담에서 학생 상태를 보고 함께 정해드립니다.</p>
</div></section>
...
function comingSoonPage(kind, url) {
  const map = {
    ...
    'others': { h1: '기타수업',
      lead: '논술·면접·시험 단기 집중 등 목표에 맞춘 특별 수업을 준비하고 있어요.' },
  };
  const v = map[kind];
  const body = `
<section class="hero"><div class="wrap">
...
<h1>목표에 맞춘 특별 수업</h1>
<p class="lead">정규 과목 수업 외에도 논술, 면접·자기소개서, 시험 기간 단기 집중, 화상 과외처럼 목표가 분명한 수업을 1:1로 진행합니다. 어떤 수업이 맞는지 모르셔도 괜찮아요. 상담에서 아이 상태를 듣고 함께 정합니다.</p>
...
<p class="sub" style="max-width:780px">특별 수업은 기간이 짧고 목표가 분명한 만큼 첫 상담이 중요합니다. 아이의 현재 상태와 목표 시점(시험일, 면접일)을 듣고, 몇 회를 어떤 순서로 진행할지 계획을 먼저 세운 뒤 선생님을 연결해 드립니다.</p>
<p class="sub" style="max-width:780px">정규 과목 수업을 받고 있는 학생은 같은 선생님이 이어서 맡을 수도 있고, 논술이나 면접처럼 전문 분야는 해당 경력의 선생님을 별도로 안내해 드립니다.</p>
</div></section>

${faqBlock([
  { q: '정규 수업 없이 특강만 받을 수 있나요?', a: '네. 시험 기간 단기 집중처럼 기간이 정해진 수업만 따로 받을 수 있습니다. 상담에서 목표와 기간을 알려주세요.' },
...
${ctaBlock('특별 수업')}`;
  ...
  return page({
    title: `기타수업 - 논술·면접·시험 단기 집중·화상 과외 1:1 | ${SITE.name}`,
    desc: `논술, 면접·자기소개서, 시험 기간 단기 집중, 화상 과외까지 목표에 맞춘 1:1 특별 수업. 상담에서 아이 상태를 듣고 계획을 함께 세웁니다.`,
    canonical: url,
    crumb: crumbs(BC),
    jsonld: crumbLd(BC),
    body,
...
<p class="sub" style="max-width:780px">같은 교과서를 써도 시험은 학교마다 다르게 나옵니다. 서술형 배점이 큰 학교가 있고, 교과서 밖 자료에서 출제하는 학교가 있으며, 수행평가 반영 비율도 제각각입니다. 그래서 학년과 과목만 보고 짜는 계획은 우리 학교 시험 앞에서 어긋나기 쉽습니다.</p>
<p class="sub" style="max-width:780px">학교를 기준으로 준비하면 무엇을 먼저 볼지가 분명해집니다. 학생이 가진 기출과 학교 프린트, 수업 중 강조된 부분을 1순위 교재로 삼고, 그 학교의 출제 방향에 맞춰 문제 유형과 서술형 연습 비중을 정합니다.</p>
</div></section>

<section><div class="wrap">
<span class="sec-tag">시험 준비</span><h2>학교 자료가 가장 정확한 교재입니다</h2>
<p class="sub" style="max-width:780px">내신 문제의 상당수는 학교 수업 자료에서 나옵니다. 선생님이 나눠준 프린트, 수업 중 강조한 부분, 교과서의 탐구 활동이 그렇습니다. 시중 문제집을 여러 권 푸는 것보다 학교 자료를 완전히 장악하는 편이 점수에 더 가까운 이유입니다.</p>
<p class="sub" style="max-width:780px">그래서 수업에서는 학생이 가진 학교 자료를 먼저 확인합니다. 필기가 부족하면 무엇을 채워야 하는지 짚어주고, 기출이 있으면 출제 패턴을 분석해 남은 기간의 우선순위를 정합니다. 서술형 배점이 큰 학교라면 답안 쓰는 훈련의 비중을 늘립니다.</p>
</div></section>

<section><div class="wrap">
<span class="sec-tag">선생님</span><h2>과외 전문 선생님이 학교별로 대비합니다</h2>
<p class="sub" style="max-width:780px">공부모아의 선생님은 경력이 증명된 과외 전문 선생님입니다. 같은 학교나 인근 학교 수업 경험이 있는 선생님이 있으면 우선 안내해 드리고, 없더라도 학생이 가진 기출과 학교 자료를 함께 분석해 대비 방향을 잡습니다. 지필 시험 대비와 함께 수행평가 일정도 챙깁니다.</p>
<p class="sub" style="max-width:780px">학교를 찾으신 뒤에는 과목별 안내로 이어집니다. 같은 학교 학생이라도 수학에서 막히는 학생과 국어에서 막히는 학생은 준비가 다르기 때문에, 학교와 과목을 함께 보고 커리큘럼을 정합니다. 어느 과목부터 시작할지 모르겠다면 상담에서 전 과목 상태를 확인하고 우선순위를 함께 잡아드립니다.</p>
</div></section>
...
function schoolPage(sc, url) {
  ...
  // 초등학교는 내신(지필 등급)이 없으므로 "내신과외" 대신 "학교 진도 맞춤 과외"로 표현한다.
  const isCho = kind === '초';
  const title = isCho
    ? (name.length > 10 ? `${name} 과외 | ${SITE.name}` : `${name} 과외 | 학교 진도 맞춤 1:1 수업 - ${SITE.name}`)
    : (name.length > 10 ? `${name} 내신과외 | ${SITE.name}` : `${name} 내신과외 | 학교 기출 맞춤 1:1 시험대비 - ${SITE.name}`);
  const desc = isCho
    ? `${name} 학생 과외 - 학교 진도와 단원평가·수행평가에 맞춰 기초를 다지는 1:1 수업입니다. 경력이 증명된 전문 선생님이 아이 속도에 맞춰 가르치고, 중학교 준비까지 함께 계획합니다.`
    : `${name} 내신 과외 - 학교 기출과 프린트를 분석해 우리 학교 출제 방향에 맞춰 대비합니다. 경력이 증명된 전문 선생님이 1:1로 수업하고, 수행평가 일정까지 함께 관리합니다.`;
  ...
  const jsonld = [{
    '@context': 'https://schema.org', '@type': 'Service',
    serviceType: isCho ? `${name} 학생 과외` : `${name} 내신 과외`, name: isCho ? `${name} 학교 진도 맞춤 과외` : `${name} 내신 대비 과외`, description: desc,
...
<h1>${esc(name)}<br><span style="color:var(--blue)">${isCho ? '학교 진도 맞춤 과외' : '내신 대비 과외'}</span></h1>
<p class="lead">${isCho
  ? `${esc(name)} 학생은 ${esc(name)} 진도에 맞춰 공부해야 합니다. 학교 진도와 단원평가 기준으로 기초를 다지는 1:1 수업을 진행해요.`
  : `${esc(name)} 시험은 ${esc(name)} 기준으로 준비해야 합니다. 학교 출제 스타일과 진도에 맞춘 1:1 수업으로 내신을 관리해 드려요.`}</p>
...
${photoTag(sdk, isCho ? `${name} 학생 공부` : `${name} 내신 공부`)}
...
${faqBlock(rotate([
  ...
  { q: '어떤 과목을 도와주시나요?', a: '초등부터 고등까지 전 과목이 가능합니다. 수학·영어·국어·과학·사회·논술과 고등 선택과목까지, 과목마다 그 과목 전문 선생님이 수업합니다. 학교 시험 일정에 맞춰 과목별 대비 순서를 함께 계획해 드려요.' },
...
<section><div class="wrap">
<span class="sec-tag">${isCho ? '과목별 수업' : '과목별 내신'}</span>
<h2>${esc(name)} 과목별 ${isCho ? '' : '내신 '}과외</h2>
<p class="sub">${isCho ? '과목마다 학교 진도에 맞춘 공부 방법이 다릅니다.' : '과목마다 우리 학교 시험 스타일에 맞춘 대비 방법이 다릅니다.'} 과목을 선택해 확인해 보세요.</p>
<div class="linkcol">
${SUBJECTS.map(s => `<a href="/schools/${slug}/${s.slug}">${esc(name)} ${s.name} ${isCho ? '' : '내신 '}과외</a>`).join('')}
</div>
</div></section>
...
function schoolSubjectPage(sc, subj, url) {
  ...
  const title = name.length > 10
    ...
    : (isCho ? `${name} ${subj.name}과외 | 학교 진도 맞춤 1:1 수업 - ${SITE.name}` : `${name} ${subj.name}과외 | 학교 기출 맞춤 내신대비 - ${SITE.name}`);
  const desc = isCho
    ? `${name} ${subj.name}과외 - 학교 진도와 단원평가에 맞춰 ${subj.name} 기초를 다지는 1:1 수업입니다. 경력이 증명된 ${subj.name} 전문 선생님이 아이 속도에 맞춰 가르치고, 30분 무료 모의수업으로 먼저 확인하실 수 있습니다.`
    : `${name} ${subj.name}과외 - 학교 기출을 분석해 ${subj.name} 출제 방향에 맞춰 대비합니다. 경력이 증명된 ${subj.name} 전문 선생님이 1:1로 수업하고, 30분 무료 모의수업으로 먼저 확인하실 수 있습니다.`;
  ...
  const ssFaqPool = [
    isCho
      ? { q: `${name} 진도에 맞춰 ${subj.name} 수업하나요?`, a: `네. ${name}의 실제 진도표와 교과서를 기준으로 그 주에 배운 내용을 그 주에 소화하도록 수업합니다. 같은 학교 학생을 가르친 경험이 있는 선생님이 있으면 우선 안내해 드립니다.` }
    ...
    isCho
      ? { q: `${subj.name} 단원평가와 수행평가를 같이 봐주시나요?`, a: `함께 관리합니다. 단원평가 시기에 맞춰 해당 단원을 정리하고, 수행평가 준비도 챙겨드립니다.` }
  ...
  const crumbItems = [
    ...
    { name: isCho ? `${subj.name} 과외` : `${subj.name} 내신` },
  ];
  const jsonld = [{
    '@context': 'https://schema.org', '@type': 'Service',
    serviceType: isCho ? `${name} ${subj.name} 과외` : `${name} ${subj.name} 내신 과외`, name: isCho ? `${name} ${subj.name} 과외` : `${name} ${subj.name} 내신 과외`, description: desc,
    areaServed: { '@type': 'Place', name: region + (reg ? ' ' + reg.dong : '') },
...
<h1>${esc(name)} ${subj.name} ${isCho ? '과외' : '내신 과외'}<br><span style="color:var(--blue)">${isCho ? '학교 진도 맞춤 수업' : '시험 스타일 맞춤 대비'}</span></h1>
<p class="lead">${isCho ? pick([
  `${esc(name)} ${subj.name}은 학교 진도를 따라가는 것보다 그 진도를 소화할 기초를 만드는 것이 핵심입니다. ${esc(name)} 진도표 기준으로 그 주에 배운 것을 그 주에 소화하는 1:1 수업을 진행합니다.`,
  `${esc(name)} 재학생을 위한 ${subj.name} 1:1 수업입니다. 학교 진도와 단원평가 시기에 맞춰 커리큘럼을 짜고, 상담 후 선생님을 연결해 드립니다.`,
  `${esc(name)} ${subj.name}, 진도만 쫓는 공부로는 기초가 남지 않습니다. 학교 진도에 맞춘 기초 다지기부터 중학교 준비까지, 아이 속도에 맞춰 준비합니다.`,
], sd, 50) : pick([
...
<section><div class="wrap">
<span class="sec-tag">수업 방식</span>
<h2>${esc(name)} ${subj.name}${isCho ? ' 과외' : ' 내신'}, 이렇게 수업해요</h2>
<div class="grid g4">
...
${(() => {
  ...
  return `<section><div class="wrap">
<span class="sec-tag">${esc(kindLabel)} ${isCho ? '학습' : '내신'} 관리</span>
...
<span class="sec-tag">주변 학교</span>
<h2>${esc(region)} 다른 ${esc(kindLabel)} ${subj.name} ${isCho ? '과외' : '내신'}</h2>
<div class="linkcol">
${nearSame.map(s2 => `<a href="/schools/${s2[4]}/${subj.slug}">${esc(s2[0])} ${subj.name} ${isCho ? '과외' : '내신'}</a>`).join('')}
</div>
</div></section>` : ''}

<section><div class="wrap">
<span class="sec-tag">다른 과목</span>
<h2>${esc(name)} 다른 과목 ${isCho ? '' : '내신 '}과외</h2>
<div class="linkcol">
${SUBJECTS.filter(s => s.slug !== subj.slug).map(s => `<a href="/schools/${slug}/${s.slug}">${esc(name)} ${s.name} ${isCho ? '' : '내신 '}과외</a>`).join('')}
...
`;
    ...
    if (path === '/rss.xml') {
      ...
      const items = [
        ...
        { t: '기타수업 | 논술·면접·시험 단기 집중·화상 과외', u: `${origin}/others`, d: '논술, 면접·자기소개서, 시험 기간 단기 집중, 화상 과외까지 목표에 맞춘 특별 수업.' },
